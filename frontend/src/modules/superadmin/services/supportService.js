...
export const supportService = {
  getTickets: async () => {
    ...
    return [
      ...
      { id: 'T-1003', subject: 'Billing invoice query - June 2026', customer: 'Alpha Logistics', priority: 'medium', status: 'pending', assignedTo: 'Jane Smith', createdAt: '5h ago', message: 'Hello, our invoice INV-2026-003 shows a pricing discrepancy of $10 compared to our starter plan agreement. Can we check this?' },
