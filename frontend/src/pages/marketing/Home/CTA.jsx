...
const CTA = () => {
    return (
        <section className="py-24 bg-white px-8">
            <div className="max-w-5xl mx-auto bg-gradient-to-br from-gray-900 via-gray-800 to-green-900 rounded-[3rem] p-12 md:p-20 text-center relative overflow-hidden shadow-2xl shadow-green-900/20">
                {/* Glow Effects */}
                ...
                <div className="relative z-10">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link to="/signup" className="px-10 py-5 rounded-full bg-green-500 text-white font-bold text-lg hover:bg-green-400 shadow-xl shadow-green-500/40 transition-all transform hover:-translate-y-1">
