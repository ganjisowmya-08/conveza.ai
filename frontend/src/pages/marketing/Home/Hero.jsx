...
const Hero = () => {
    return (
        <section className="relative min-h-[90vh] bg-white overflow-hidden flex items-center">
            {/* Background Glows */}
            <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] rounded-full bg-green-400/20 blur-[120px] pointer-events-none" />
            ...
            <div className="max-w-7xl mx-auto px-8 w-full grid lg:grid-cols-2 gap-16 items-center relative z-10">
                {/* Left */}
                <div>
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-green-50 border border-green-100 text-green-700 font-semibold text-sm mb-8 shadow-sm">
                    ...
                    <div className="flex gap-4 mt-10">
                        <Link to="/signup" className="px-8 py-4 rounded-full bg-green-600 text-white font-bold hover:bg-green-700 shadow-xl shadow-green-500/30 transition-all transform hover:-translate-y-1">
                            Start Free Trial
                        </Link>
                ...
                <div className="relative lg:h-[600px] flex items-center justify-center">
                    <div className="absolute inset-0 bg-gradient-to-tr from-green-100 to-emerald-50 rounded-[3rem] transform rotate-3 scale-105" />
                    ...
                    <div className="relative bg-white p-6 rounded-3xl shadow-2xl border border-gray-100 w-full max-w-lg z-10 transform -rotate-2 hover:rotate-0 transition-transform duration-500">
                        <div className="flex items-center gap-4 mb-6 pb-6 border-b border-gray-100">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-green-600 font-medium">Online & Engaging</p>
                            </div>
                        </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="bg-green-600 text-white rounded-2xl p-4 rounded-tr-none w-[80%] ml-auto text-sm">
                            ...
                            <div className="bg-gray-50 rounded-2xl p-4 rounded-tl-none w-[85%] text-sm text-gray-600 flex flex-col gap-3">
                                ...
                                <button className="bg-white text-green-600 border border-green-200 py-2 rounded-lg font-bold shadow-sm">
                                    Buy Now - $49
                                </button>
                            </div>
                        </div>
