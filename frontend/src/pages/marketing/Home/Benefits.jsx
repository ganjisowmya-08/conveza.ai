        ...
        <section className="py-24 bg-white">
            <div className="max-w-7xl mx-auto px-8">
                <div className="text-center mb-20">
                    <h2 className="text-primary font-bold tracking-wide uppercase text-sm mb-3">The Conveza Advantage</h2>
                    <h1 className="text-5xl font-extrabold text-gray-900 mb-6 tracking-tight">Massive ROI, Zero Effort</h1>
                </div>

                <div className="grid md:grid-cols-3 gap-8">
                    {/* Benefit 1 */}
                    <div className="p-8 rounded-3xl bg-primary/5 border border-primary/10 flex flex-col items-center text-center hover:-translate-y-2 transition-transform duration-300">
                        <div className="text-5xl font-extrabold text-primary mb-4">3x</div>
                    ...
                    {/* Benefit 2 */}
                    <div className="p-8 rounded-3xl bg-primary/10 border border-primary/20 flex flex-col items-center text-center hover:-translate-y-2 transition-transform duration-300">
                        <div className="text-5xl font-extrabold text-primary mb-4">80%</div>
                    ...
                    <div className="p-8 rounded-3xl bg-gray-900 text-white flex flex-col items-center text-center shadow-2xl hover:-translate-y-2 transition-transform duration-300 relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            <div className="text-5xl font-extrabold text-accent mb-4">24/7</div>
