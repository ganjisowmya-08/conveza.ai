        ...
        <section className="py-24 bg-white">
            <div className="max-w-7xl mx-auto px-8">
                <div className="text-center mb-16">
                    <h2 className="text-green-600 font-bold tracking-wide uppercase text-sm mb-3">The Platform</h2>
                        ...
                        <div className="flex h-[500px]">
                            ...
                            <div className="flex-1 p-8 bg-white flex flex-col">
                                <div className="flex justify-between items-center mb-8">
                                    ...
                                    <div className="w-32 h-10 bg-green-600 rounded-lg"></div>
                                </div>
                                ...
                                <div className="grid grid-cols-3 gap-6 mb-8">
                                    <div className="h-32 bg-gray-50 rounded-2xl border border-gray-100 p-4">
                                        ...
                                        <div className="w-32 h-10 bg-green-100 rounded"></div>
                                    </div>
                                    <div className="h-32 bg-gray-50 rounded-2xl border border-gray-100 p-4">
                                        <div className="w-20 h-6 bg-gray-200 rounded mb-4"></div>
