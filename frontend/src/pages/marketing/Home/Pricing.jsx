        ...
        <section className="py-24 bg-white">
            <div className="max-w-7xl mx-auto px-8">
                <div className="text-center mb-16">
                    <h2 className="text-green-600 font-bold tracking-wide uppercase text-sm mb-3">Simple Pricing</h2>
                ...
                <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto items-center">
                    {/* Starter */}
                    <div className="bg-white p-8 rounded-[2rem] border border-gray-200 shadow-sm flex flex-col hover:border-green-200 transition-colors">
                        ...
                        <ul className="space-y-4 mb-8 flex-1 text-sm font-medium text-gray-700">
                            <li className="flex items-center gap-3">
                                <span className="text-green-500">✓</span> 5,000 AI Messages/mo
                            </li>
                            <li className="flex items-center gap-3">
                                <span className="text-green-500">✓</span> Unlimited Human Agents
                            </li>
                            <li className="flex items-center gap-3">
                                <span className="text-green-500">✓</span> Shared Team Inbox
                            </li>
                            <li className="flex items-center gap-3">
                                <span className="text-green-500">✓</span> Basic Broadcasting
                            </li>
                        </ul>
                    ...
                    {/* Pro */}
                    <div className="relative p-8 rounded-[2rem] flex flex-col transform md:-translate-y-4 bg-gray-900 text-white shadow-2xl shadow-green-500/20 ring-2 ring-green-500">
                        <div className="absolute -top-4 inset-x-0 flex justify-center">
                            <span className="bg-gradient-to-r from-green-500 to-emerald-400 text-white text-xs font-extrabold uppercase tracking-widest py-1.5 px-4 rounded-full shadow-lg shadow-green-500/30">
                                Most Popular
                            </span>
                        </div>
                        ...
                        <ul className="space-y-4 mb-8 flex-1 text-sm font-medium text-gray-300">
                            <li className="flex items-center gap-3">
                                <span className="text-green-400">✓</span> 25,000 AI Messages/mo
                            </li>
                            <li className="flex items-center gap-3">
                                <span className="text-green-400">✓</span> Advanced Autonomous Agents
                            </li>
                            <li className="flex items-center gap-3">
                                <span className="text-green-400">✓</span> Click-to-WhatsApp Ads Manager
                            </li>
                            <li className="flex items-center gap-3">
                                <span className="text-green-400">✓</span> Smart Retargeting
                            </li>
                            <li className="flex items-center gap-3">
                                <span className="text-green-400">✓</span> HubSpot & Salesforce CRM
                            </li>
                        </ul>
                        <button className="w-full py-3 rounded-xl bg-gradient-to-r from-green-600 to-emerald-500 text-white font-bold shadow-lg hover:shadow-green-500/40 transition-all transform hover:-translate-y-0.5">
                            Start Free Trial
                        </button>
                    </div>
                    ...
                    <div className="bg-white p-8 rounded-[2rem] border border-gray-200 shadow-sm flex flex-col hover:border-gray-300 transition-colors">
                        ...
                        <ul className="space-y-4 mb-8 flex-1 text-sm font-medium text-gray-700">
                            <li className="flex items-center gap-3">
                                <span className="text-green-500">✓</span> Custom Fine-Tuned AI Models
                            </li>
                            <li className="flex items-center gap-3">
                                <span className="text-green-500">✓</span> Dedicated Account Manager
                            </li>
                            <li className="flex items-center gap-3">
                                <span className="text-green-500">✓</span> Custom API Integrations
                            </li>
                            <li className="flex items-center gap-3">
                                <span className="text-green-500">✓</span> 99.99% SLA Uptime
                            </li>
                        </ul>
